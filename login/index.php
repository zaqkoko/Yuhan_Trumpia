  ...
  <head>
    ...
    <style media="screen">
         *
         ...
         h1
         {font-size:130px; font-weight:bold; color:#fff; padding-top:100px;}
         table
         {color:#fff; font-weight:bold; font-size:20px; padding-left:15px;}
         table input
         {border:none; background:#fff; color:#7dabd0; font-weight:bold; font-size:20px;}
         a
         {color : #fff;}
    </style>
